...
use module_mp_GRAUPEL, only: GRAUPEL_INIT, M2005MICRO_GRAUPEL, &
      ...
      arctic_ice_nuclei_Nice, & ! options for fixing Nice where RHice > ..._rhi_thresh
      arctic_ice_nuclei_rhi_thresh
...
subroutine micro_setparm()
  ...
  integer ierr, ios, ios_missing_namelist, place_holder
   ...
   arctic_ice_nuclei_Nice = 0.16 ! ice number concentration in # per liter.
   arctic_ice_nuclei_rhi_thresh = 1. ! threshold RHice for Nice == arc..._Nice.

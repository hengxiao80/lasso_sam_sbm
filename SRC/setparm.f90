...
!use radarlidar_simulator_types ! for SBM radar simulator (MO: mikhail@pnnl.gov)
...
!                doradarsim, mie_table_name, hclass_file, radar_freq,    &
!                use_gas_abs, use_mie_table, radar_flag,                 &
...
!        hclass_file = 'NONE'
!        radar_freq = 35
!        use_gas_abs = 2         ! 1 to calculate gas atten; 0 not to
!        use_mie_table = 1       ! 1 to use premade tables; 0 to calculate
!        radar_flag = 1          ! 1 for ground-based radar; 0 for space-based
                                                                                           
!        lidar_table_name = 'NONE'
!        lidar_wavelen = 0.532
!        fov_l = 2.5e-5
!        fov_t = 5.0e-5
!        use_ms = 0
!        lidar_alt = 0.0
!        use_solid_ice = 1
! END Add for SBM radar simulator

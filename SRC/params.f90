...
implicit none
!MO real :: tprecip = 10000000. ! Unit:day, For VOCALS to call precip after 1 h
real :: tprecip = 3600. ! Unit=s, For VOCALS to call precip after 1 h
!   Constants:
...
! added by fan fpr radar simulator
logical:: notopenedradarsim = .false. ! flag to see if the radarsimulator output datafile is opened 
logical:: doradarsim = .true.
